...
"""
# @Author: AristoYU
# @Date: 2025-03-10 10:47:55
# @LastEditTime: 2025-03-10 11:34:59
# @LastEditors: AristoYU
# @Description:
# @FilePath: /LR-learning/PPO/agent.py
"""
...
from ppo.utils import layer_init
...
class PPOLightningAgent(LightningModule):
    ...
    def training_step(self, batch: dict[str, Tensor]):
        ...
        # update metrics
        self.avg_pg_loss.update(pg_loss)
        self.avg_value_loss.update(v_loss)
        self.avg_ent_loss.update(ent_loss)
